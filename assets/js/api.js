// Generated by esbuild from TypeScript source
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/static.js
var static_exports = {};
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/options.js
var defaultOpts2 = {
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/attributes.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/utils.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/traversing.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/manipulation.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/parse.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/css.js
var css_exports = {};
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/forms.js
var forms_exports = {};
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/api/extract.js
var extract_exports = {};
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/cheerio.js
var Cheerio = class {
  /**
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/load.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/parsers/parse5-adapter.js
...
// node_modules/.pnpm/cheerio@1.1.2/node_modules/cheerio/dist/browser/load-parse.js
...
function formatPublishAt(dateStr) {
  if (!dateStr) return dateStr;
  const date = (0, import_dayjs.default)(dateStr, "YYYY/MM/DD HH:mm");
  if (!date.isValid()) return dateStr;
  const weekdays = ["\u5468\u65E5", "\u5468\u4E00", "\u5468\u4E8C", "\u5468\u4E09", "\u5468\u56DB", "\u5468\u4E94", "\u5468\u516D"];
  const weekday2 = weekdays[date.day()];
  return `${date.format("M\u6708D\u65E5")}${weekday2} ${date.format("HH:mm")}`;
}
function parseTagsAndTitle(text3) {
  let temp = text3.replace(/【/g, "[").replace(/】/g, "]");
...
function getWeekSectionName(name) {
  return weekSectionNames[name] || name;
}

// src/mikan.ts
var _MikanApi = class _MikanApi {
  constructor() {
    this.baseUrl = _MikanApi.BASE_URLS[_MikanApi.BASE_URLS.length - 1];
  }
  // ==================== Configuration ====================
  getBaseUrl() {
    return this.baseUrl;
  ...
  getAvailableBaseUrls() {
    return [..._MikanApi.BASE_URLS];
  }
  // ==================== API Methods ====================
  async index(year, seasonStr) {
  ...
  async search(searchstr, subgroupid = "", page = 1) {
    ...
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseSearch($2);
  }
  async list(page = 1) {
    const url = `${this.baseUrl}/Home/Classic/${page}`;
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseList($2);
  }
  async subgroup(subgroupId) {
    const url = `${this.baseUrl}/Home/PublishGroup/${subgroupId}`;
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseSubgroup($2);
  }
  async bangumi(bangumiId) {
    const url = `${this.baseUrl}/Home/Bangumi/${bangumiId}`;
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseBangumi($2);
  }
  async bangumiMore(bangumiId, subtitleGroupId, take = 65) {
    ...
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseBangumiMore($2);
  }
  async details(episodeId) {
    const url = `${this.baseUrl}/Home/Episode/${episodeId}`;
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseRecordDetail($2);
  }
  async getMySubscribed() {
    const url = `${this.baseUrl}/Home/MyBangumi`;
    const html3 = await this.fetchHtml(url);
    const $2 = load(html3);
    return this.parseMySubscribed($2);
  }
  async mySubscribedSeasonBangumi(year, seasonStr) {
  ...
  async login(email, password, returnUrl = "") {
    ...
    const html3 = await this.fetchHtml(loginUrl);
    const $2 = load(html3);
    const token = this.parseRefreshLoginToken($2);
    const params = new URLSearchParams({
      UserName: email,
      Password: password,
      RememberMe: "true",
  ...
  async register(email, password, confirmPassword) {
    ...
    const html3 = await this.fetchHtml(registerUrl);
    const $2 = load(html3);
    const token = this.parseRefreshRegisterToken($2);
    const params = new URLSearchParams({
      Email: email,
      Password: password,
  ...
  async forgotPassword(email) {
    ...
    const html3 = await this.fetchHtml(forgotUrl);
    const $2 = load(html3);
    const token = this.parseRefreshForgotPasswordToken($2);
    const params = new URLSearchParams({
      Email: email,
      __RequestVerificationToken: token || ""
    });
  ...
  async subscribeBangumi(bangumiId, subtitleGroupId) {
    const data2 = {
      BangumiID: bangumiId
    };
    if (subtitleGroupId) {
      data2.SubtitleGroupID = subtitleGroupId;
    }
    const cookies = await this.loadCookiesForUrl(this.baseUrl);
    const headers = {
  ...
  async unsubscribeBangumi(bangumiId, subtitleGroupId) {
    const data2 = {
      BangumiID: bangumiId
    };
    if (subtitleGroupId) {
  ...
  // ==================== Parse Methods ====================
  parseIndex($2) {
    const bangumiRows = this.parseSeason($2);
    const rss = this.parseDay($2);
    const carousels = this.parseCarousel($2);
    const years = this.parseYearSeason($2);
    const user = this.parseUser($2);
    const announcements = this.parseAnnouncement($2);
    ...
    return {
      ...
      carousels,
      user: user || void 0,
      announcements: announcements.length > 0 ? announcements : void 0
    };
  }
  parseSeason($2) {
    const rows = [];
    $2("div.sk-bangumi").each((_, rowEle) => {
      const $row = $2(rowEle);
      const row = {
  ...
  parseDay($2) {
    const items = [];
    $2("#an-list-res .my-rss-item").each((_, ele) => {
      const $item = $2(ele);
      const record = { id: "", name: "", title: "", tags: [], cover: "", torrent: "", magnet: "", url: "", size: "", publishAt: "", groups: [] };
  ...
  parseUser($2) {
    const name = trim($2("#user-name .text-right").first().text() || "");
    const avatar = trim($2("#user-welcome #head-pic").attr("src") || "");
    const token = trim($2("#login input[name=__RequestVerificationToken]").attr("value") || "");
    const rss = trim($2("#an-episode-updates .mikan-rss").attr("href") || "");
    if (!name && !avatar && !token && !rss) {
      return null;
    }
    return {
      name: name || void 0,
      avatar: avatar ? this.baseUrl + avatar : void 0,
      token: token || void 0,
      rss: rss ? this.baseUrl + rss : void 0
    };
  }
  parseRefreshLoginToken($2) {
    return trim($2("#login input[name=__RequestVerificationToken]").attr("value") || "") || null;
  }
  parseRefreshRegisterToken($2) {
    return trim($2("input[name=__RequestVerificationToken]").attr("value") || "") || null;
  }
  parseRefreshForgotPasswordToken($2) {
    return trim($2("input[name=__RequestVerificationToken]").attr("value") || "") || null;
  }
  parseSearch($2) {
    const subgroups = [];
    $2("div.leftbar-container .leftbar-item .subgroup-longname").each((_, ele) => {
      const $ele = $2(ele);
    ...
    const bangumis = [];
    $2("div.central-container > ul > li").each((_, ele) => {
      const $ele = $2(ele);
    ...
    const records = [];
    $2("tr.js-search-results-row").each((_, ele) => {
      const $row = $2(ele);
  ...
  parseList($2) {
    const records = [];
    $2("#sk-body > table > tbody > tr").each((_, ele) => {
      const $row = $2(ele);
      const $tds = $row.children();
      if ($tds.length < 5) return;
      const record = { groups: [], title: "", tags: [], url: "", magnet: "", size: "", torrent: "", publishAt: "" };
  ...
  parseCarousel($2) {
    const carousels = [];
    $2("#myCarousel > div.carousel-inner > div.item.carousel-bg").each((_, ele) => {
      const $ele = $2(ele);
  ...
  parseYearSeason($2) {
    const selected = trim($2("#sk-data-nav .date-select div.date-text").text() || "");
    const yearSeasons = [];
    $2("#sk-data-nav > div > ul.navbar-nav.date-select > li > ul > li").each((_, ele) => {
      const $li = $2(ele);
      const year = {
        year: trim($li.children().first().text()),
        seasons: []
      };
      $li.children().eq(1).children().each((_2, e) => {
        const $e = $2(e);
  ...
  parseSubgroup($2) {
    const galleries = [];
    $2("#js-sort-wrapper > div.pubgroup-timeline-item[data-index]").each((_, ele) => {
      const $item = $2(ele);
      const title = `${trim($item.find(".pubgroup-date").text())} ${trim($item.find(".pubgroup-season").text())}`;
      const bangumis = [];
      $item.find("li[data-bangumiid]").each((_2, e) => {
        const $e = $2(e);
        bangumis.push({
  ...
  parseBangumi($2) {
    const $link = $2("#sk-container > div.pull-left.leftbar-container > p.bangumi-title > a");
    const id = $link.attr("href")?.split("=")[1] || "";
    const $poster = $2("#sk-container > div.pull-left.leftbar-container > div.bangumi-poster");
    ...
    const name = trim($2("#sk-container > div.pull-left.leftbar-container > p.bangumi-title").text() || "");
    let intro = trim($2("#sk-container > div.central-container > p").text() || "");
    if (intro) {
      intro = "\u3000\u3000" + intro.replace(/\n/g, "\n\u3000\u3000");
    }
    const $subscribedBadge = $2("#sk-container .subscribed-badge");
    const subscribed = $subscribedBadge.length > 0 ? ($subscribedBadge.attr("style") || "").trim().length === 0 : false;
    const more = {};
    $2("#sk-container > div.pull-left.leftbar-container > p.bangumi-info").each((_, ele) => {
      const $ele = $2(ele);
      const text3 = trim($ele.text());
    ...
    const $tables = $2("#sk-container > div.central-container > div.episode-table > table");
    const $subs = $2(".subgroup-text");
    $tables.each((i, table) => {
      const $sub = $subs.eq(i);
      const subgroupBangumi = this.parseSubgroupBangumi($sub);
      const records = [];
      $2(table).find("tbody > tr").each((_, tr) => {
        records.push(this.parseRecordItemFromRow($2(tr)));
      });
  ...
  parseSubgroupBangumi($sub) {
    ...
    const subscribed = $subele.attr("style") === void 0;
    ...
    const rss = rssHref ? this.baseUrl + rssHref : void 0;
    const subgroups = [];
  ...
  parseRecordDetail($2) {
    const id = $2("#sk-container > div.pull-left.leftbar-container > div.leftbar-nav > button").attr("data-bangumiid") || "";
    const $poster = $2("#sk-container > div.pull-left.leftbar-container > div.bangumi-poster");
    const posterStyle = $poster.attr("style") || "";
    const coverMatch = posterStyle.match(/'([^']+)'/);
    const cover = this.baseUrl + (coverMatch ? coverMatch[1].split("?")[0] : "");
    const name = trim($2("#sk-container > div.pull-left.leftbar-container > p.bangumi-title").text() || "");
    const title = trim($2("#sk-container > div.central-container > div.episode-header > p").text() || "");
    let tags = [];
    let parsedTitle = "";
    if (title) {
    ...
    let torrent = "";
    let magnet = "";
    $2("#sk-container > div.pull-left.leftbar-container > div.leftbar-nav > a").each((_, ele) => {
      const $a = $2(ele);
      const text3 = trim($a.text());
      if (text3 === "\u4E0B\u8F7D\u79CD\u5B50") {
    ...
    const $desc = $2("#sk-container > div.central-container > div.episode-desc");
  ...
  parseBangumiMore($2) {
    const records = [];
    $2("tbody > tr").each((_, ele) => {
      records.push(this.parseRecordItemFromRowAlt($2(ele)));
    });
    return records;
  }
  parseMySubscribed($2) {
  ...
  parseAnnouncement($2) {
    const announcements = [];
    $2(".announcement-popover-content > div").each((_, ele) => {
      const $div = $2(ele);
      const $date = $div.find(".anndate");
      const date = trim($date.text() || "");
      $date.remove();
      const nodes = [];
      $div.contents().each((_2, node) => {
        if (node.type === "text") {
  ...
  // ==================== Helper Methods ====================
  async bridgeCall(action, data2) {
    try {
      return await fjs.bridge_call({ action, ...data2 });
    } catch (e) {
      return null;
    }
  }
  async getDomainFromUrl(url) {
    try {
  ...
  async saveCookiesFromResponse(response, url) {
    const domain = await this.getDomainFromUrl(url);
    const cookieHeaders = [];
...
_MikanApi.MIRROR_URL_KEY = "MIRROR_URL";
_MikanApi.BASE_URLS = ["https://mikanime.tv", "https://mikanani.me"];
var MikanApi = _MikanApi;
var mikan_default = new MikanApi();
export {
  mikan_default as default
};
